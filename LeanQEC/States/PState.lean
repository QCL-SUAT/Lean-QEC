...
lemma PState.kron_val (n₁ n₂) {ψ₁ : PState n₁} {ψ₂ : PState n₂} {x : BitVec (n₁ + n₂)} :
  ...
  simp [PState.kron, ket_prod, toMat_symm_apply', toMat_apply', normalized_kron,
    Matrix.kronecker, Matrix.kroneckerMap_apply, Matrix.reindex_apply, Matrix.submatrix_apply]
